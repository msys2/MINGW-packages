...
!
       ...
       PARAMETER (MPI_DATATYPE_NULL=201326592)  ! MPI_DATATYPE_NULL=z'0c000000'
...
!GCC$ ATTRIBUTES DLLIMPORT :: MPI_BOTTOM, MPI_IN_PLACE, MPI_STATUS_IGNORE
!GCC$ ATTRIBUTES DLLIMPORT :: MPI_STATUSES_IGNORE, MPI_ERRCODES_IGNORE
!GCC$ ATTRIBUTES DLLIMPORT :: MPI_UNWEIGHTED
!GCC$ ATTRIBUTES DLLIMPORT :: MPI_WEIGHTS_EMPTY
!GCC$ ATTRIBUTES DLLIMPORT :: MPI_ARGVS_NULL, MPI_ARGV_NULL

! These variables were originally exported in COMMON blocks (for Intel Fortran)
!
