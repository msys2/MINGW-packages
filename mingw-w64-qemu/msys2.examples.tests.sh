...
echo "QEMU desktop (DVD), QEMU disk image utility (QIMG),"
echo "QEMU guest agent (QGA) or QEMU plugins (QPI)"
read -p "Your choice? (2014|2016|2018|2020|2023|QIMG|QGA|QPI|[DVD]) " BLOCK
echo
